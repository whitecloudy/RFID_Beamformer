...
std::vector<int> Directional_beamtrainer::getDirectional(int angle_x, int angle_y){ 
  ...
  std::complex<double> yStepAngle = beam_util::phase2NormalComplex(180.0 * std::sin(Deg2Rad(angle_y)));   //be power this because the distance between antenna set in Y axis is wider in double
